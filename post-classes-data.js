...
const PAGE_TITLE = "Module:Classes/data";
const FILE_PATH = path.join(__dirname, "luatables", "classes.lua"); // Path to your local file
        ...
        client.logIn((err, response) => {
            ...
            client.getArticle(PAGE_TITLE, (err, data) => {
                ...
                client.edit(PAGE_TITLE, newContent, `(Automated Update) Updated data for version ${VERSION_NAME}`, (err, resultData) => {
                    ...
                    console.log(`Classes data updated to ${VERSION_NAME}`);
                })
            });
        });
    } catch (error) {
